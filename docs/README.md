...
The repository root contains an unrelated Next.js/Prisma application. This
static app is fully self-contained inside `docs/` so it doesn't touch or
conflict with that codebase — it has its own `index.html`, `css/`, and
`js/`, and no build step of any kind.
...
3. Under **Build and deployment → Source**, choose **Deploy from a
   branch**.
4. Pick your branch (e.g. `main`) and set the folder to **`/docs`**.
5. Save. GitHub will publish the app at
   `https://<your-username>.github.io/<repo-name>/`.

No build step, no environment variables, no server — the folder is served
